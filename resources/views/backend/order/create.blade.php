                        ...
                        <div class="row mt-3 mb-2">
                            <div class="col-md-12">
                                <div class="card-box card">
                                    <div class="row">
                                      <div class="col-md-9">
                                        <h2 class="mt-0 mb-3">Sell Now <i class="ml-2 fa fa-shopping-cart"></i></h2>
                                      </div>
                                      <div class="col-md-3 text-right sm-btn">
                                          <a href="{{url('order')}}" class="btn btn-sm btn-primary">Sell History <i class="fa fa-list ml-1"></i></a>
                                      </div>
                                    ...
                                    <form role="form" action=@if(isset($product) )
                                          {{route('product.update',$product->id)}} @else() {{route('order.store')}} @endif method="post" >
                                            @if (isset($product))
                                                @method('PUT')
                                            @endif
                                                ...
                                                <div class="card-box" style="box-shadow: 0 20px 35px 0 lightgrey; border-radius:25px;">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group card-box" id="rows bg-info" style="box-shadow: 0 25px 35px 0 lightgrey; border-radius:25px;">
                                                              ...
                                                              <div class="row">
                                                                <div class="mt-sm-3 col-md-3 mx-2">
                                                                    <button type="submit" class="btn btn-primary text-uppercase">Submit</button>
                                                                </div>
                                                                <div  class="mt-sm-3 ml-auto col-md-2 mx-2 ">
                                                                    {{-- <span>Total amount</span> --}}
                                                                    <input type="text" name="" class="form-control sub_total" id="sub_total" value="" readonly>
                                                                  </div>
                                                              </div>
...
function dynamic_field(number)
  {
    ...
    html = '<tr>';
          html += '<td> <select name="products[]"  class="form-control pid select2" ><option value="" readonly>Chose Product</option>{{!! \App\Http\Controllers\SellController::fetch_products() !!}</select></td>';
          html += '<td><input type="number" name="quantity[]" class="form-control qty" value="0"/><input type="hidden" name="total_quantity" class="form-control tqty" /></td>';
          html += '<td><input type="text" name="total_price[]" val="" class="form-control price"/></td>';
